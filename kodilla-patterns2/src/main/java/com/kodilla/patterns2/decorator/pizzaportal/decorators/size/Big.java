...
public class Big extends AbstractPizzaOrderDecorator {
    public Big(PizzaOrder pizzaOrder) {
        super(pizzaOrder);
    }

    @Override
    public BigDecimal getCost() {
        return super.getCost().add(super.getCost().multiply(new BigDecimal(1.5)));
    }

    @Override
    public String getDescription() {
        return super.getDescription() + "Size: 60cm ";
    }
}